...
gaara = Shinobi.new(name:'Gaara', age:15, classs:'Genin', damage:7, nation:'Suna')
kankuro = Shinobi.new(name:'Kankuro', age:17, classs:'Genin', damage:3, nation:'Suna')
temari = Shinobi.new(name:'Temari', age:17, classs:'Genin', damage:3, nation:'Suna')
